...
- `avatarUrl` is an already-uploaded R2 URL — see `SPEC-26` (presigned upload) and `flows/file-upload-flow.md` for how the client gets it before calling this endpoint.
