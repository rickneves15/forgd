...
- Photos/pdfs are already-uploaded R2 URLs by the time this endpoint is called — see `SPEC-26` (presigned upload) and `flows/file-upload-flow.md` for how the client gets those URLs before calling this endpoint.
